...
$stmt = $dbh->prepare("UPDATE workers SET worker_name = :worker_name, worker_sname = :worker_sname, worker_tname = :worker_tname, address = :address, position_id = :position_id, facility_id = :facility_id, on_vacation = :on_vacation WHERE worker_id = :worker_id");
$stmt->bindParam(':worker_id', $_POST['id']);
